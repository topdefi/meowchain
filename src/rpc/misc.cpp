...
UniValue validateaddress(const JSONRPCRequest& request)
{
	...
	//1 use command 'meowcoind -daemon=0', do not use command meowcoind -daemon
	//2 'meowcoin-cli validateaddress HSFs8aqGLDbYk242PQiv5oguQL5Tqk5d' in other console window.
	...
	//meowcoin-cli validateaddress HXissueAssetk242PQiv5oguQL5TqhhZGt
