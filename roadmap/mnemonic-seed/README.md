...
When using the 12-word seed which will be the new default, the address derivation will change to be compatible with the BIP32/BIP39/BIP44 standards.  Since this is already implemented in the Meowcoin mobile wallet, the 12-words will be cross-compatible.  The derivation path is m/44'/1669'/0'/0 for the first non-change address.
...
### Compatibility
Other wallets like Jaxx and Coinomi use a 12-word seed.  For wallets that use BIP39/BIP32/BIP44 and the correct coinid of 1669 for Meowcoin, the 12-words should be compatible with external wallets.
