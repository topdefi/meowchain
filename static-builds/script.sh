...
rm -rf ~/meowcoincoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../meowcoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../meowcoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/meowcoincoin/temp
cd ~/meowcoincoin/temp
tar xf ../$SOURCEDIST
...
cd ~/
rm -rf win64
cp -rf meowcoincoin/contrib/windeploy ~/sign/win64
cd ~/sign/win64/windeploy
mkdir -p unsigned
mv ~/meowcoincoin/meowcoin-*setup-unsigned.exe unsigned/
...
cd ~/
rm -rf win32
cp -rf meowcoincoin/contrib/windeploy ~/sign/win32
...
mkdir -p ~/meowcoincoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/meowcoincoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
cd ~/meowcoincoin/depends/SDKs && tar -xf MacOSX10.11.sdk.tar.gz 
