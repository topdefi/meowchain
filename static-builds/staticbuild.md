...
sudo find ${DISTNAME}/bin -type f -executable -exec ../meowcoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
sudo find ${DISTNAME}/lib -type f -exec ../meowcoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
~/meowcoincoin/contrib/macdeploy/extract-osx-sdk.sh
...
git clone https://github.com/JustAResearcher/Meowcoin
mkdir ~/meowcoincoin/depends/SDKs
#transfer MacOSX10.11.sdk.tar.gz to the folder meowcoincoin/depends/SDKs
